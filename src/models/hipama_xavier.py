...
class HiPAMA(nn.Module):
    def __init__(self, embed_dim, depth, input_dim=84, num_heads=4):
        ...
        nn.init.xavier_uniform_(self.phn_proj.weight)
        ...
        nn.init.xavier_uniform_(self.rep_w1.weight)
        self.rep_w2 = nn.Linear(embed_dim, embed_dim)
        nn.init.xavier_uniform_(self.rep_w2.weight)
        self.rep_w3 = nn.Linear(embed_dim, embed_dim)
        nn.init.xavier_uniform_(self.rep_w3.weight)
        ...
        nn.init.xavier_uniform_(self.mlp_head_word1[1].weight)
        self.mlp_head_word2 = nn.Sequential(nn.LayerNorm(embed_dim), nn.Linear(embed_dim, 1))
        nn.init.xavier_uniform_(self.mlp_head_word2[1].weight)
        self.mlp_head_word3 = nn.Sequential(nn.LayerNorm(embed_dim), nn.Linear(embed_dim, 1))
        nn.init.xavier_uniform_(self.mlp_head_word3[1].weight)
        ...
        nn.init.xavier_uniform_(self.rep_utt1.weight)
        self.rep_utt2 = nn.Linear(embed_dim, embed_dim)
        nn.init.xavier_uniform_(self.rep_utt2.weight)
        self.rep_utt3 = nn.Linear(embed_dim, embed_dim)
        nn.init.xavier_uniform_(self.rep_utt3.weight)
        self.rep_utt4 = nn.Linear(embed_dim, embed_dim)
        nn.init.xavier_uniform_(self.rep_utt4.weight)
        self.rep_utt5 = nn.Linear(embed_dim, embed_dim)
        nn.init.xavier_uniform_(self.rep_utt5.weight)
